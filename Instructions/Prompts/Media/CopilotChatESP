...
### Tarea 1: Perform Online Research & Analysis  

Usando **Copilot Chat**, gather insights on relevant topics by analyzing internal sources such as emails, chat history, and SharePoint documentation. Then, broaden your research with industry articles, external reports, or relevant websites.  
...
**Ejemplo de indicación** *(if no internal topic is available)*:
...
> **CONSEJO:**  If the first response is too broad or too shallow, refine your prompt by adding more context (e.g., specific region, industry, or time frame).
